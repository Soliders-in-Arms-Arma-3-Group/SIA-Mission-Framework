...
_action = ["missionEndWin", "Win", "", { [[true, (side group player)],"sia_f\endMission.sqf"] remoteExec ["execVM", 2] }, { sia_f_missionStarted }] call ace_interact_menu_fnc_createAction;
[["ACE_ZeusActions", "missionEnd"], _action] call ace_interact_menu_fnc_addActionToZeus;

_action = ["missionEndLose", "Lose", "", { [[false, (side group player)],"sia_f\endMission.sqf"] remoteExec ["execVM", 2] }, { sia_f_missionStarted }] call ace_interact_menu_fnc_createAction;
[["ACE_ZeusActions", "missionEnd"], _action] call ace_interact_menu_fnc_addActionToZeus;
